...
execute if block ~-1 ~2 ~ #minecraft:temporary_marker run tag @s add 3
...
execute if block ~1 ~2 ~ #minecraft:temporary_marker run tag @s add 9
...
execute if entity @s[tag=success_1] run fill ~-1 ~ ~ ~ ~2 ~ minecraft:nether_portal[axis=x] replace #minecraft:temporary_marker
execute if entity @s[tag=success_2] run fill ~ ~ ~ ~1 ~2 ~ minecraft:nether_portal[axis=x] replace #minecraft:temporary_marker

# Replace any Non-Successful Blocks
fill ~-1 ~ ~ ~1 ~2 ~ minecraft:air replace #minecraft:temporary_marker
