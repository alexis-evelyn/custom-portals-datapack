...
# Top Layer
execute as @s in alexis:glass run setblock ~-2 ~3 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~-1 ~3 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~ ~3 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~1 ~3 ~ minecraft:crying_obsidian keep

# Left Side
execute as @s in alexis:glass run setblock ~1 ~0 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~1 ~1 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~1 ~2 ~ minecraft:crying_obsidian keep

# Right Side
execute as @s in alexis:glass run setblock ~-2 ~0 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~-2 ~1 ~ minecraft:crying_obsidian keep
execute as @s in alexis:glass run setblock ~-2 ~2 ~ minecraft:crying_obsidian keep

# Portal Frames
execute as @s in alexis:glass run fill ~ ~0 ~ ~-1 ~2 ~ minecraft:nether_portal[axis=x] keep