...
execute unless entity @e[name=CustomPortalsOtherSideMarker, type=minecraft:armor_stand] run summon minecraft:armor_stand 0 -10 0 {CustomName:"\"CustomPortalsOtherSideMarker\"", NoGravity: true, CustomNameVisible: false, Invisible: true, Marker: true}