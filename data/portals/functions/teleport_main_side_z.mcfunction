...
# Right Side
execute as @s in minecraft:overworld run fill ~ ~ ~-1 ~ ~2 ~-1 minecraft:crying_obsidian keep

# Portal Frames
execute as @s in minecraft:overworld run fill ~ ~ ~1 ~ ~2 ~ minecraft:nether_portal[axis=z] keep